...
namespace Neira.Bot.Helpers
{
	public static class DatabaseHelper
	{
		...
		/// <summary>
		/// Get user daily glimmer or return refresh time
		/// </summary>
		/// <param name="userId"></param>
		/// <returns></returns>
		public static async Task<DailyResult> GetDailyAsync(ulong userId)
		{
			using (var Db = new NeiraLinkContext())
			{
				...
				else
				{
					...
					{
						Id = userId,
						Glimmer = GlobalVariables.DailyGlimmerGain
					};
		...
		/// <summary>
		/// Get discord guild user account or create new for adding reputation
		/// </summary>
		/// <param name="user"></param>
		/// <returns></returns>
		public static async Task<DailyResult> GetRepAsync(SocketGuildUser user)
		{
			using (var Db = new NeiraLinkContext())
			{
		...
		/// <summary>
		/// Get user account and add 1 reputation point or create account with 1 rep. point
		/// </summary>
		/// <param name="user"></param>
		/// <returns></returns>
		public static async Task AddRepAsync(SocketGuildUser user)
		{
			using (var Db = new NeiraLinkContext())
			{
