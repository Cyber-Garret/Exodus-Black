...
//
//    var getActivityHistory = GetActivityHistory.FromJson(jsonString);

namespace Neira.API.Bungie.Models.Results.Destiny2
{
	using System;
	...
	public partial class GetActivityHistory
	{
	...
	public partial class GetActivityHistory
	{
		public static GetActivityHistory FromJson(string json) => JsonConvert.DeserializeObject<GetActivityHistory>(json, Neira.API.Bungie.Models.Results.Destiny2.Converter.Settings);
	}

	public static class Serialize
	{
		public static string ToJson(this GetActivityHistory self) => JsonConvert.SerializeObject(self, Neira.API.Bungie.Models.Results.Destiny2.Converter.Settings);
	}
